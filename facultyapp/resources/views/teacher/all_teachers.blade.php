                                ...
                                @foreach($allteachers as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('delete.teacher',$item->id)}}" title="delete teacher"><button class="btn btn-danger btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Delete</button></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
